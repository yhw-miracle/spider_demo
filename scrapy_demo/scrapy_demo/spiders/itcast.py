...
class ItcastSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for teacher in teacher_list:
            ...
            teacher_item["name"] = teacher.xpath('./div[@class="li_txt"]/h3/text()').extract_first()
            teacher_item["level"] = teacher.xpath('./div[@class="li_txt"]/h4/text()').extract_first()
            teacher_item["description"] = teacher.xpath('./div[@class="li_txt"]/p/text()').extract_first()
